...
import com.example.comer.myproject.Interface.RestInterfaceController6;
...
public class FiveNews extends Activity {


    private ListView listview;
    private RestAdapter restAdapter;
    private RestInterfaceController6 restInterface;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        restInterface = restAdapter.create(RestInterfaceController6.class);

        progressDialog = new ProgressDialog(FiveNews.this);
