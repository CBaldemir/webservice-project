...
import com.example.comer.myproject.Interface.RestInterfaceController3;
...
public class SecondNews extends Activity {


    private ListView listview;
    private RestAdapter restAdapter;
    private RestInterfaceController3 restInterface;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        restInterface = restAdapter.create(RestInterfaceController3.class);

        progressDialog = new ProgressDialog(SecondNews.this);
