...
import com.example.comer.myproject.Interface.RestInterfaceController4;
...
public class ThirdNews extends Activity {


    private ListView listview;
    private RestAdapter restAdapter;
    private RestInterfaceController4 restInterface;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        restInterface = restAdapter.create(RestInterfaceController4.class);

        progressDialog = new ProgressDialog(ThirdNews.this);
